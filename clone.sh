...
git clone git@github.com:stefanbauer/stefanbauer.com.git $PERSONAL/stefanbauer
git clone git@github.com:stefanbauer/stefanbauer.me.git $PERSONAL/stefanbauer-legacy
git clone git@github.com:stefanbauer/zimmerei-ernstl-landtamic.git $PERSONAL/zimmerei-ernstl-landtamic
git clone git@github.com:stefanbauer/zimmerei-ernstl.de.git $PERSONAL/zimmerei-ernstl
